...
_emitter4 setParticleParams [["\A3\data_f\ParticleEffects\Universal\Universal.p3d",16,7,48,1],"","Billboard",1,11,[0,0,0],[0,0,0],1,1.00,0.8,0.15,[3,8],[[0.7897,0.63513,0.516593,0.193464],[0.8,0.7,0.6,0.15],[0.9,0.8,0.8,0.06],[1,1,1,0.01]],[0.5],0.2,0.1,"","","",0,false,0,[[100,200,90,0]],[0,1,0]];
_emitter4 setParticleRandom [2,[2,2,2],[0.3,0.3,0.3],10,0.3,[0,0,0,0.3],0,0,360,0];
_emitter4 setParticleCircle [0,[0,0,0]];
_emitter4 setParticleFire [0,0,0];
_emitter4 setDropInterval 0.005;

uisleep 1;
deleteVehicle _emitter1;
deleteVehicle _emitter3;
deleteVehicle _emitter4;
uisleep 2;
